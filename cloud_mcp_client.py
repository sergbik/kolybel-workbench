...
class CloudMCPClient:
    ...
    def upload_graph(self, local_path, github_path="knowledge_graph_v4.graphml", message=None):
        ...
        # Проверяем, существует ли файл в репозитории, чтобы получить SHA
    ...
    def download_graph(self, github_path="knowledge_graph_v4.graphml", local_path=None):
        ...
        return False, "Файл не найден в репозитории."

if __name__ == "__main__":
    # Тестовый блок (будет использован в оркестраторе)
    # Токен будет подтягиваться из окружения или файла ключ.txt
    pass
